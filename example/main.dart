...
void main() async {
  ...
  // Fetch the JWT token
  // Add your token function to fetch the token when
  ...
  final socket = WebSocket(uri,
      backoff: backoff,
    //  tokenFunction: add your token function to fetch token on reconnect
    //  addFunction: add any function you would like to call on websoket reconnect
